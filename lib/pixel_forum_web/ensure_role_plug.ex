defmodule PixelForumWeb.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug PixelForumWeb.EnsureRolePlug, [:user, :admin]

      plug PixelForumWeb.EnsureRolePlug, :admin

      plug PixelForumWeb.EnsureRolePlug, ~w(user admin)a
  """
  ...
  defp maybe_halt(_any, conn) do
    conn
    |> Controller.put_flash(:error, "Not authorized.")
