...
pid = spawn(fn -> Enum.reduce(0..1000000, fn t, _acc -> PixelForum.Images.ImageServer.change_pixel(lobby_id, 0, {rem(floor(200 + :rand.uniform(30) + t*9), 512), rem(floor(200 + t*2 + :rand.uniform(2)), 512)}, {250, rem(floor(2*t), 255), 255}) end) end)
