...
Enum.reduce(0..100000, fn t, _acc -> PixelForum.Images.ImageServer.change_pixel(lobby_id, 0, {rem(floor(200 + :rand.uniform(30) + t*9), 512), rem(floor(200 + t*2), 512)}, {250, rem(floor(2*t), 255), 0}) end)
