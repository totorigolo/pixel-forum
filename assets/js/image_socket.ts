...
let user_token_meta: HTMLMetaElement = document.querySelector('meta[name="user_ws_token"]');
...
let socket = new Socket("/msgpack-socket", {
    ...
    decode: (packed_payload: string, callback: (decoded: any) => void) => {
        let decoded = msgpack.decode(new Uint8Array(packed_payload as unknown as ArrayBuffer));
...
let imageCanvas: HTMLCanvasElement = document.querySelector("#image-canvas");
...
let inputX: HTMLInputElement = document.querySelector("#input-x")
let inputY: HTMLInputElement = document.querySelector("#input-y")
let inputR: HTMLInputElement = document.querySelector("#input-r")
let inputG: HTMLInputElement = document.querySelector("#input-g")
let inputB: HTMLInputElement = document.querySelector("#input-b")
